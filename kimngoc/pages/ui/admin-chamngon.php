...
if (isset($_GET['delete'])) {
  ...
  header('location:admin-chamngon');
  ...
  <div class="container-scroller">
    ...
    <div class="main-panel">
              ...
              <div class="card-body">
                ...
                <form action="" method="POST" class="forms-sample" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="exampleInputName1">Câu nói</label>
                  ...
                  <button type="submit" class="btn btn-success mr-2" name="add_chamngon">Submit</button>
      ...
      <div class="content-wrapper">
        <div class="row">
          <?php
          $show_chamngon = $conn->prepare("SELECT * FROM `chamngon` ORDER BY id DESC");
          $show_chamngon->execute();
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="">
                      <img style="width:200px" src="../../../mid_img/<?= $fetch_chamngon['image']; ?>" alt="trandugold">
                      <div class="name">Tên Slider :<h3>
                          <?= $fetch_chamngon['name']; ?>
                        </h3>
                      </div>
                      <div class="flex-btn">
                        <a href="admin-update-chamngon?update=<?= $fetch_chamngon['id']; ?>"
                          class="btn btn-warning">Sửa</a>
                        <a href="admin-chamngon?delete=<?= $fetch_chamngon['id']; ?>" class="btn btn-danger"
