...
<head>
  ...
  <title>Update content mid</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
      ...
      <div class="content-wrapper">
        <div class="row">
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Edit Content Mid</h4>
   ...
   ?>
                    <form action="" method="POST" class="forms-sample" enctype="multipart/form-data">
                      ...
                      <input type="hidden" name="name" value="<?= $fetch_mid['name']; ?>">
                      <input type="hidden" name="old_image" value="<?= $fetch_mid['image']; ?>">
                      <img style="width:200px" src="../../../slider_img/<?= $fetch_mid['image']; ?>" alt="">
                      <div class="form-group">
                        <label class="card-people mt-auto" for="exampleInputName1">Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="name" placeholder="Name" value="<?= $fetch_mid['name']; ?>">
                      </div>

                      <div class="form-group">
                        <label class="card-people mt-auto" for="exampleInputName1">Text1</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="text1" placeholder="Text1" value="<?= $fetch_mid['text1']; ?>">
                      </div>

                      <div class="form-group">
                        <label class="card-people mt-auto" for="exampleInputName1">Text2</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="text2" placeholder="Text2" value="<?= $fetch_mid['text2']; ?>">
                      </div>

                      <div class="form-group">
                        <label class="card-people mt-auto" for="exampleInputName1">Text3</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="text3" placeholder="Text3" value="<?= $fetch_mid['text3']; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <a href="admin-mid" class="btn btn-warning">Cancel</a>
                    </form>
                    <?php
         }
      }else{
